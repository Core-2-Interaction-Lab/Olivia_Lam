...
var invertChecker = document.getElementById('invert');
var radius = document.getElementById('radius');
var paragraph = new EscapingText('text');

invertChecker.addEventListener('change',function(){
  paragraph.invert = this.checked;
});

radius.addEventListener('change',function(){
  paragraph.radius = this.value;
});
